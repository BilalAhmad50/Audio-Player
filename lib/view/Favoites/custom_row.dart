...
class OnTapPressableRowListForFavorites extends StatelessWidget {
  final Widget startIcon;
  final String title;
  final String subTitle;
  final Widget endIcon;
  final VoidCallback onTap; // Callback for regular tap
  final VoidCallback onMoreVertTap; // Callback for "more_vert" icon tap
